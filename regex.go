...
var (
	...
	PN_CHARS_BASE = regexp.MustCompile("[a-zA-Z]|[\u00C0-\u00D6]|[\u00D8-\u00F6]|[\u00F8-\u02FF]|[\u0370-\u037D]|[\u037F-\u1FFF]|" + "[\u200C-\u200D]|[\u2070-\u218F]|[\u2C00-\u2FEF]|[\u3001-\uD7FF]|[\uF900-\uFDCF]|[\uFDF0-\uFFFD]")
	...
	UCHAR         = regexp.MustCompile("\\\\u" + HEX.String() + HEX.String() + HEX.String() + HEX.String() + "|\\\\U" + HEX.String() + HEX.String() + HEX.String() + HEX.String() + HEX.String() + HEX.String() + HEX.String() + HEX.String())

	BLANK_NODE_LABEL                 = regexp.MustCompile("_:(" + "(?:" + PN_CHARS_U.String() + ")" + "|[0-9])((" + "(?:" + PN_CHARS.String() + ")" + "|[\\.])*" + "(?:" + PN_CHARS.String() + ")" + ")?")
	...
	PN_PREFIX    = regexp.MustCompile("(?:(?:" + PN_CHARS_BASE.String() + ")(?:(?:" + PN_CHARS.String() + "|[\\.])*(?:" + PN_CHARS.String() + "))?)")
	...
	PN_LOCAL     = regexp.MustCompile("((?:" + PN_CHARS_U.String() + "|[:]|[0-9]|" + PLX.String() + ")(?:(?:" + PN_CHARS.String() + "|[.]|[:]|" + PLX.String() + ")*(?:" + PN_CHARS.String() + "|[:]|" + PLX.String() + "))?)")
